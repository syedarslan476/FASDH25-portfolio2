...
# build a dictionary of patterns from the place names in the first column:    (Help from chatgpt)
patterns = {}
rows = data.split("\n")
for row in rows[1:]:
    columns = row.split("\t")
...
mentions_per_month = {}        
#War time in Gaza  - Help from chatgpt
...
# print the frequency of each pattern:   help from chatgpt
...
rows = []
for place in mention_per_month:
